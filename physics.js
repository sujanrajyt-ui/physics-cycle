...
// Add Physics Unit 2 – Quantum Computing
if (!quizData["Physics"]) {
  quizData["Physics"] = {};
}

Object.assign(quizData["Physics"], {
...
// Add Physics Unit 3 – Conductors and Superconductors
if (!quizData["Physics"]) {
  quizData["Physics"] = {};
}
...
// Add Physics Unit 4 – Semiconductors
if (!quizData["Physics"]) {
  quizData["Physics"] = {};
}
...
Object.assign(quizData["Physics"], {
  "Unit 4: Semiconductors": [
    ...
    // Q3 in your text had formulas unreadable; skipped here
    {
      text: "The relationship between current density J and electric field E is",
      options: [
        "J = σE",
...
// Add Physics Unit 5 – Lasers and Optical Fibers
if (!quizData["Physics"]) {
  quizData["Physics"] = {};
}
