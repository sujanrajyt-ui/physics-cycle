...
// Add Basic Electronics Unit 2 – BJT and MOSFET
if (!quizData["Basic Electronics"]) {
  quizData["Basic Electronics"] = {};
}

Object.assign(quizData["Basic Electronics"], {
  "Unit 2: BJT and MOSFET": [
    ...
    },
    {
      ...
      correctIndex: 1  // as per your answer key
    },
    {
...
// Add Basic Electronics Unit 3 – Operational Amplifiers
if (!quizData["Basic Electronics"]) {
  quizData["Basic Electronics"] = {};
}
...
// Add Basic Electronics Unit 4 – Oscillators and Feedback
if (!quizData["Basic Electronics"]) {
  quizData["Basic Electronics"] = {};
}
...
// Add Basic Electronics Unit 5 – Communication & Embedded Systems
if (!quizData["Basic Electronics"]) {
  quizData["Basic Electronics"] = {};
}
